...
#----------------------------------------------------------------------------------------
    # Endre Eres
    # Dummy ROS Publisher - Subscriber example: single_ros_pub_sub_1.py
    # V.2.0.0.
#----------------------------------------------------------------------------------------
...
class single_ros_pub_sub_1():

    def __init__(self):

        time.sleep(1) # Wait for the bridge to start

        rospy.init_node('single_ros_pub_sub_1', anonymous=False)
